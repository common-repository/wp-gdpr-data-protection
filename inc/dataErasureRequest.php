...
if( !defined( 'ABSPATH' ) ) exit;  // Exit if accessed directly
	...
	$requests_table = new WooEnc_Data_Removal_Requests_Table( array(
...
<div class="wrap wooenc">
	<h1><?php esc_html_e( 'Data Erasure Request' ); ?></h1>
	<hr class="wp-header-end">

	<?php settings_errors(); ?>

	<form method="post" class="wp-privacy-request-form" action="<?php echo admin_url( 'admin.php' ); ?>?page=wooenc_remove_personal_data">
		...
		<input type="hidden" name="_wp_http_referer" value="<?php echo admin_url( 'admin.php' ); ?>?page=wooenc_remove_personal_data">
		<input type="hidden" name="action" value="wooenc_add_export_personal_data_request">
		<input type="hidden" name="type_of_action" value="wooenc_remove_personal_data">
	</form>
	<hr>
	...
	<form class="search-form wp-clearfix">
		...
		<input type="hidden" name="page" value="wooenc_remove_personal_data" />
